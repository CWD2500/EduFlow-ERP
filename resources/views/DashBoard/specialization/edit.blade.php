                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('dashBoard.specialization.update' ,[$specialization->id]) }}" method="POST" >
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control " name="name" id="name" placeholder="أدخل  الاسم الاختصاص..." value="{{$specialization->name}}"  required />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
