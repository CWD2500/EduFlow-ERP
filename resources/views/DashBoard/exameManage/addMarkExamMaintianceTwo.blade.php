            ...
            <div class="page-inner">
                <div class="page-header">
                    ...
                    <ul class="breadcrumbs mb-3">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('dashBoard.exams.manage.view.main') }}"> قسم الصيانة  </a>
                        </li>
                        <li class="separator">
                            <i class="icon-arrow-right"></i>
                        </li>
                ...
                <div class="row">
                    ...
                    @endif
                          ...
                          @endif
                            ...
                            <form action="{{ route('dashBoard.exams.manage.view.main.year.two.store') }}"  method="POST" >
                                @csrf
                                @method('POST')
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="form-group mb-3">
                                                <p for="student" class="form-label" style="font-size: 20px">المادة الدراسية
                                                </p>
