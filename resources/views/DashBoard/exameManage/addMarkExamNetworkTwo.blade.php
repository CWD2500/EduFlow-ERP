            ...
            <div class="page-inner">
                <div class="page-header">
                    ...
                    <ul class="breadcrumbs mb-3">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('dashBoard.exams.manage.view.network') }}"> قسم الشبكات  </a>
                        </li>
                        <li class="separator">
                            <i class="icon-arrow-right"></i>
                        </li>
                        <li class="nav-item">
                            <a href="#">  السنة ثانية  </a>
                        </li>
                    </ul>
                </div>
                <div class="row">
                    ...
                    @endif
                          ...
                          @endif
                            ...
                            <form action="{{ route('dashBoard.exams.manage.view.network.year.two.store') }}"  method="POST" >
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <a href="{{ route('dashBoard.exams.manage.view.network') }}" class="mt-2">
