                ...
                <div class="row">
                    ...
                    @endif
                          ...
                          @endif
                            ...
                            <form action="{{ route('dashBoard.exams.manage.view.mark.programming.year.two.update' , [$exame_edit->id]) }}"  method="POST" >
                                @csrf
                                @method('PUT')
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="form-group mb-3">
                                                <p for="student" class="form-label" style="font-size: 20px" >  اسم الطالب 
                                                </p>
                                                <select class="form-control" id="searchable_select" name="student_id" style="width: 100%;">
                                                    ...
                                                    <option value="{{ $item->student_id }}" {{ $item->student_id == $exame_edit->student_id ? 'selected' : '' }} >
                                                        {{ $item->student_name }} : ({{ $item->student_id }})  الرقم الجامعي </option>    
                                                @endforeach
                                                </select>
                                            </div>
                                        </div>
...
{{--     
                                        <div class="col-md-6 col-lg-6">
                                            <div class="form-group mb-3">
                                                <p for="subject_id" class="form-label" style="font-size: 20px">المادة الدراسية
                                                </p>
                                                <select class="form-control" id="subject_id" name="subject_id" required>
                                                    <!-- الخيارات تأتي من قاعدة البيانات -->
                                                    
                                                    @foreach ($subject_prog as $item)
                                                    @if ($item->year =='السنة الثانية' )
                                                            <option value="{{ $item->name }}"  {{$item->name == $exame_edit->subject_id ? 'selected' : ''}} >{{ $item->name }}</option>
                                                        @endif
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="number" class="form-control" name="degree_n" min="0"  max="20"   id="decimal_number"
                                                    name="decimal_number" step="0.01"  value="{{$exame_edit->degree_n}}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="number" class="form-control" name="degree_p" min="0"  max="20"  id="decimal_number"
                                                    name="decimal_number" step="0.01" value="{{$exame_edit->degree_p }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="number" class="form-control" name="exam_n"  min="0"  max="30"  id="decimal_number"
                                                    name="decimal_number" step="0.01" value="{{$exame_edit->exam_n}}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="number" class="form-control" name="exam_p"   value="{{$exame_edit->exam_p}}" min="0"  max="30"  id="decimal_number"
                                                    name="decimal_number" step="0.01" required>
                                            </div>
                                        </div>
    ...
    <script>
          $(document).ready(function() {
            ...
            function loadSubjects(semester) {
                $.ajax({
                    url: "{{ route('fetch.subjects.by.semester.prog.two') }}",
                    method: 'GET',
                    data: {
                        semester: semester,
                        year: 'السنة الثانية',
                        specialization_id: 'قسم البرمجة'
                    },
