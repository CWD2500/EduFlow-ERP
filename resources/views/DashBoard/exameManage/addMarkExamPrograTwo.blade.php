            ...
            <div class="page-inner">
                <div class="page-header">
                    ...
                    <ul class="breadcrumbs mb-3">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('dashBoard.exams.manage.view.programming.year.one') }}"> قسم البرمجة  </a>
                        </li>
                        <li class="separator">
                            <i class="icon-arrow-right"></i>
                        </li>
                ...
                <div class="row">
                    ...
                    @endif
                          ...
                          @endif
                            ...
                            <form action="{{ route('dashBoard.exams.manage.view.programming.year.two.store') }}"  method="POST" >
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <select class="form-control" id="searchable_select" name="student_id" style="width: 100%;">
                                                    ...
                                                    @if ($item->year_one_student =='السنة الثانية')
                                                            <option value="{{ $item->student_id }}">{{ $item->student_name }}: ({{ $item->student_id }})  الرقم الجامعي </option>
                                                        @endif
                                                        @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <a href="{{ route('dashBoard.exams.manage.view.programming.year.one') }}" class="mt-2">
    ...
    <script>
        $(document).ready(function() {
            function loadSubjects(semester) {
                $.ajax({
                    url: "{{ route('fetch.subjects.by.semester') }}",
                    method: 'GET',
                    data: {
                        semester: semester,
                        year: 'السنة الثانية',
