            ...
            <div class="page-inner">
                <div class="page-header">
                    ...
                    <ul class="breadcrumbs mb-3">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('dashBoard.addMarkSupplementDepNetwork.manage') }}"> قسم الشبكات  </a>
                        </li>
                        <li class="separator">
                            <i class="icon-arrow-right"></i>
                        </li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <form action="{{ route('dashBoard.addMarkSupplementDepNetworkTwo.manage.store') }}" method="POST">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <a href="{{ route('dashBoard.addMarkSupplementDepNetwork.manage') }}" class="mt-2">
