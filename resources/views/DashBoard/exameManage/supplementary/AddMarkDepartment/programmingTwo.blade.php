            ...
            <div class="page-inner">
                <div class="page-header">
                    ...
                    <ul class="breadcrumbs mb-3">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('dashBoard.addMarkSupplementDepProg.manage') }}"> قسم البرمجة  </a>
                        </li>
                        <li class="separator">
                            <i class="icon-arrow-right"></i>
                        </li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <form action="{{ route('dashBoard.addMarkSupplementDepProgrammingTwo.manage.store') }}" method="POST">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <a href="{{ route('dashBoard.addMarkSupplementDepProg.manage') }}" class="mt-2">
