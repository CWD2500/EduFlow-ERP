...
<div class="main-panel">
    ...
    <div class="container">
        <div class="page-inner">
            ...
            <form method="GET" action="{{ route('dashBoard.exams.manage.view.mark.programming.year.one') }}" class="ActionNoneDisplay">
            ...
            <div class="row">
                @php
                    $firstYearStudents = $examsprg->where('academic_year', 'السنة الاولى');
                ...
                @foreach ($subjectGroups as $subject_id => $students)
                    <div class="table-container">
                        ...
                        <h4>السنة الاولى قسم هندسة البرمجيات</h4>
                                ...
                                @foreach ($students as $student)
                                    ...
                                    <tr>
                                        ...
                                        <td class="ActionNoneDisplay">
                                            ...
                                            <a class="btn btn-success" href="{{ route('dashBoard.exams.manage.view.mark.programming.year.one.edit', [$student->id]) }}">
