...
<div class="main-panel">
    ...
    <div class="container">
        <div class="page-inner">
            ...
            <form method="GET" action="{{ route('dashBoard.exams.manage.view.mark.manitnace.year.one') }}" class="ActionNoneDisplay">
            ...
            <div class="row">
                @php
                    $firstYearStudents = $examsnetmin->where('academic_year', 'السنة الاولى');
                    $subjectGroups = $firstYearStudents->groupBy('subject_id');
                    $i = 1;
                @endphp
                ...
                @foreach ($subjectGroups as $subject_id => $students)
                    <div class="table-container">
                        ...
                        <h4>السنة الأولى قسم هندسة الصيانة</h4>
                                ...
                                @foreach ($students as $student)
                                    ...
                                    <tr>
                                        ...
                                        <td class="ActionNoneDisplay">
                                            ...
                                            <a class="btn btn-success" href="{{ route('dashBoard.exams.manage.view.mark.EditAllMarkStudentMainOne.year.one.edit', [$student->id]) }}">
