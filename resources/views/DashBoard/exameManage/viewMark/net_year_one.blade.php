...
<div class="main-panel">
    ...
    <div class="container">
        <div class="page-inner">
            ...
            <form method="GET" action="{{ route('dashBoard.exams.manage.view.mark.network.year.one') }}" class="ActionNoneDisplay">
            ...
            <div class="row">
                @php
                    $firstYearStudents = $examsnetwork->where('academic_year', 'السنة الاولى');
                                ...
                                @foreach ($students as $student)
                                    ...
                                    <tr>
                                        ...
                                        <td class="ActionNoneDisplay">
                                            ...
                                            <a class="btn btn-success" href="{{ route('dashBoard.exams.manage.view.mark.network.year.one.edit', [$student->id]) }}">
