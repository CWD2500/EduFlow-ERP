        ...
        <div class="container">
            <div class="page-inner">
                ...
                <div class="row justify-content-around">
                    ...
                    <div class="col-md-6 ">
                        <a href="{{ route('dashBoard.exams.manage.view.mark.programming.year.one') }}">
                            <div class="card"  style="    font-size: 25px;padding: 38px;background: blue;color: white;text-align: center;" >
                                <h4>  نتائج البرمجة النسة الاول  </h4>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-6 ">
                        <a href="{{ route('dashBoard.exams.manage.view.mark.programming.year.tow') }}">
                            <div class="card"  style="    font-size: 25px;padding: 38px;background: blue;color: white;text-align: center;" >
                                <h4>  نتائج البرمجة النسة الثانية  </h4>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-md-6 ">
                        <a href="{{ route('dashBoard.exams.manage.view.mark.network.year.one') }}">
                          
                        <div class="card"  style="    font-size: 25px;padding: 38px;background: rgb(79, 2, 151);color: white;text-align: center;" >
                            <h4>  نتائج الشبكات النسة الاول  </h4>
                        </div>
                        </a>
                    </div>
                    <div class="col-md-6 ">
                        <a href="{{ route('dashBoard.exams.manage.view.mark.network.year.tow') }}">
                        <div class="card"  style="    font-size: 25px;padding: 38px;background: rgb(79, 2, 151);color: white;text-align: center;" >
                    ...
                    <div class="col-md-6 ">
                        <a href="{{ route('dashBoard.exams.manage.view.mark.manitnace.year.one') }}">
                    ...
                    <div class="col-md-6 ">
                        <a href="{{ route('dashBoard.exams.manage.view.mark.manitnace.year.tow') }}">
                        <div class="card"  style="    font-size: 25px;padding: 38px;background: rgb(25 22 78);color: white;text-align: center;" >
