...
<div class="main-panel">
    ...
    <div class="container">
        <div class="page-inner">
            ...
            <form method="GET" action="{{ route('dashBoard.exams.manage.view.mark.programming.year.tow') }}" class="ActionNoneDisplay">
            ...
            <div class="row">
                @php
                    $secondYearStudents = $examsprg->where('academic_year', 'السنة الثاني');
                ...
                @foreach ($subjectGroups as $subject_id => $students)
                    <div class="table-container">
                        ...
                        <h4>السنة الثانية قسم هندسة البرمجيات</h4>
                                ...
                                @foreach ($students as $student)
                                    ...
                                    <tr>
                                        ...
                                        <td class="ActionNoneDisplay">
                                            ...
                                            <a class="btn btn-success" href="{{ route('dashBoard.exams.manage.view.mark.programming.year.two.edit', [$student->id]) }}">
