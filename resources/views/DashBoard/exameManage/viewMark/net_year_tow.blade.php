...
<div class="main-panel">
    ...
    <div class="container">
        <div class="page-inner">
            ...
            <form method="GET" action="{{ route('dashBoard.exams.manage.view.mark.network.year.tow') }}" class="ActionNoneDisplay">
            ...
            <div class="row">
                @php
                    $secondYearStudents = $examsnetwork->where('academic_year', 'السنة الثانية');
                ...
                @foreach ($subjectGroups as $subject_id => $students)
                    <div class="table-container">
                        ...
                        <h4>السنة الثانية قسم هندسة الشبكات</h4>
                                ...
                                @foreach ($students as $student)
                                    ...
                                    <tr>
                                        ...
                                        <td class="ActionNoneDisplay">
                                            ...
                                            <a class="btn btn-success" href="{{ route('dashBoard.exams.manage.view.mark.network.year.two.edit', [$student->id]) }}">
