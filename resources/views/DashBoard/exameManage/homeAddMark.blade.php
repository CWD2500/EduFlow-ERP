            ...
            <div class="page-inner">
                ...
                <div class="container">
                    ...
                    <div class="page-inner">
                       ...
                       <div class="row">
                            <div class="col-md-6">
                                <a href="{{ route('dashBoard.exams.manage.view.programming.year.one') }}">
                            ...
                            <div class="col-md-6">
                                <a href="{{ route('dashBoard.exams.manage.view.network') }}">
                                <div class="card  myExameCard" >
                            ...
                            <div class="col-md-12">
                                <a href="{{ route('dashBoard.exams.manage.view.main') }}">
                                <div class="card  myExameCard" >
