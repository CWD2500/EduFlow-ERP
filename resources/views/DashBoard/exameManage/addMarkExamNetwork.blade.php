            ...
            <div class="page-inner">
                <div class="page-header">
                    ...
                    <ul class="breadcrumbs mb-3">
                        ...
                        <li class="separator"><i class="icon-arrow-right"></i></li>
                        <li class="nav-item"><a href="{{ route('dashBoard.exams.manage.view.network') }}">قسم الشبكات</a></li>
                        <li class="separator"><i class="icon-arrow-right"></i></li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <form action="{{ route('dashBoard.exams.manage.student.mark.storeAddMarkNetwork.store') }}" method="POST">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
    ...
    <script>
        $(document).ready(function() {
            function loadSubjects(semester) {
                $.ajax({
                    url: "{{ route('fetch.subjects.by.semester.net') }}",
                    method: 'GET',
                    data: {
                        semester: semester,
                        year: 'السنة الاولى',
