                            ...
                            <tbody>
                                @foreach ($student as $students)
                                    <tr>
                                        ...
                                        <td>{{$students->date_of_registration}}</td>
                                        <td class="text-center">
                                                    
                                            <a href="{{ route('dashBoard.student.deleteTrash', [$students->id]) }}" class="btn btn-outline-danger w-25"> <i class="fa fa-trash"></i> </a>
                                            <a href="{{ route('dashBoard.student.edit', [$students->id]) }} " class="btn btn-outline-success w-25"> <i class="fa fa-edit"></i> </a>
                                            <a href="{{ route('dashBoard.student.show', [$students->id]) }}" class="btn btn-outline-primary w-25"> <i class="fa fa-eye"></i> </a>
                                        </td>
                                    </tr>
                              @endforeach
